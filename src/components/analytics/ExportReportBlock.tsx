        ...
        return (
          <button
            ...
            className={`flex items-center space-x-4 p-4 rounded-xl border text-left 
                hover:scale-[1.02] transition-all group cursor-pointer shadow-sm ${report.bg}`}
          >
            <div className="p-2.5 rounded-lg bg-white shadow-sm group-hover:shadow-md transition-all">
