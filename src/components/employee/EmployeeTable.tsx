    ...
    <div className="rounded-xl border border-[#D9D9D9] bg-white h-full flex flex-col">
      ...
      <div className="overflow-x-auto">
        <table className="w-full table-fixed">
          <thead>
            <tr className="border-b space-x-2 border-[#D9D9D9] bg-[#FAFAFA]">
              <th className="w-[280px] lg:w-[120px] px-6 py-4 text-left text-xs font-semibold">
                Employee
              </th>

              <th className="w-[160px] md:w-[120px] px-8 py-4 text-left text-xs font-semibold">
                Department
              </th>

              <th className="w-[120px] px-4 py-4 text-left text-xs font-semibold">
                Role
              </th>

              <th className="w-[130px] px-3 py-4 text-left text-xs font-semibold">
                Onboarding Status
              </th>
          ...
          <tbody>
            {paginatedEmployees.map((employee) => {
              const DepartmentIcon = employee.departmentIcon;

              return (
                <tr key={employee.id} className="border-b border-[#E5E5E5]">
                  <td className="px-3 py-4 w-[280px]">
                    <div className="flex items-center gap-3 min-w-0">
                      <div className="relative h-12 w-12 overflow-hidden rounded-full bg-[#F3F3F3]">
                        <Image
                          src={employee.avatar}
                          alt={employee.name}
                          fill
                  ...
                  <td className="w-[120px] px-3 py-4 text-[10px] whitespace-nowrap">
                    {employee.role}
                  </td>
